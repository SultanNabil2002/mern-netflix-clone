const LIST_CONTENT_1_ID = [
    {
        title: "Nikmati di TV-mu",
        desc: "Tonton di Smart TV, Playstation, box, Chroecast, Apple TV, Pemutar Blu-ray, dan banyak lagi."
    }
]

const LIST_CONTENT_2_ID = [
    {
...
const LIST_CONTENT_2_EN = [
    {
        title: "Download your shows to watch offline",
        desc: "Save your favorites easily and always have sommething to watch."
    }
]

const LIST_CONTENT_3_EN = [
    {
        title: "Watch Everywhere",
        desc: "Stream unlimited mmovies and TV shows on your phone, tablet, laptop, and TV."
    }
]

const LIST_CONTENT_4_EN = [
    {
