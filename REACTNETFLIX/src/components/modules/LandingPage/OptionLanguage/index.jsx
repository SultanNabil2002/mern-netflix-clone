// src/components/modules/OptionLanguage/index.jsx
...
const OptionLanguage = () => {
    ...
    return (
        <div className='relative bg-[#1A1510] text-white rounded border border-gray-400 w-[200px] pl-7'>
